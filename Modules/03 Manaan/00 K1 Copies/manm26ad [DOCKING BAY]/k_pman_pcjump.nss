...
void main() {
	object oMan_party0_jump = GetObjectByTag("man_party0_jump", 0);
	object oMan_party1_jump = GetObjectByTag("man_party1_jump", 0);
	object oMan_party2_jump = GetObjectByTag("man_party2_jump", 0);
	SetPartyLeader(0xFFFFFFFF);
	sub1(1.0);
	SetFacingPoint(GetPosition(GetObjectByTag("man_party0_jump", 0)));
	DelayCommand(0.2, sub2(oMan_party0_jump, oMan_party1_jump, oMan_party2_jump));
}
