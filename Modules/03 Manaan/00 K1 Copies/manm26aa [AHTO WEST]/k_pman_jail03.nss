...
void main() {
	if (GetGlobalBoolean("MAN_GO_TO_JAIL")) {
		SetGlobalBoolean("MAN_GO_TO_JAIL", 0);
		object oMan26_selward = GetObjectByTag("man26_selward", 0);
		AssignCommand(oMan26_selward, ActionStartConversation(GetFirstPC(), "man26_selauth", 0, 0, 1, "", "", "", "", "", ""));
	}
}
