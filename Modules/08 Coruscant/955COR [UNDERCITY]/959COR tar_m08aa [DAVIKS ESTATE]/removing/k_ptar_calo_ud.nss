					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							if ((GetCurrentHitPoints(OBJECT_SELF) < (GetMaxHitPoints(OBJECT_SELF) / 2))) {
								...
								object oNearestTar08_wpexplosion = GetNearestObjectByTag("tar08_wpexplosion", oDavik082, 1);
								sub1(oNearestTar08_wpexplosion);
								SetMinOneHP(oDavik082, 0);
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 2000)) {
												int int5;
												object object5;
												sub2("Surrendering", 5, 5, 5.0);
												ClearAllActions();
												SurrenderToEnemies();
												CancelCombat(GetPartyMemberByIndex(0));
												NoClicksFor(0.7);
												DelayCommand(0.5, ActionStartConversation(GetPartyMemberByIndex(0), "tar08_calo082", 0, 0, 1, "", "", "", "", "", ""));
											}
										}
									}
								}
