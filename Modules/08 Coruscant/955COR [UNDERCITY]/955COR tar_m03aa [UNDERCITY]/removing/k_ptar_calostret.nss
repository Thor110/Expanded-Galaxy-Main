...
void main() {
	ApplyEffectToObject(0, EffectDeath(0, 1), GetObjectByTag("rodian035", 0), 0.0);
	ApplyEffectToObject(0, EffectDeath(0, 1), GetObjectByTag("rodian036", 0), 0.0);
	sub1(GetObjectByTag("calo032", 0));
	sub3(GetObjectByTag("tar03_sw03aae", 0), 0);
}
