...
del "Expanded Galaxy Main Installer\tslpatchdata\changes-macappstore.ini"
del "Expanded Galaxy Main Installer\tslpatchdata\changes-macsteam.ini"
...
type changes\changes-disc-intro.ini			changes\changes.ini changes\changes-legacy-outro.ini		override.txt > "Expanded Galaxy Main Installer\tslpatchdata\changes-disc.ini"
...
type changes\changes-gog-legacy-intro.ini	changes\changes.ini changes\changes-legacy-outro.ini		override.txt > "Expanded Galaxy Main Installer\tslpatchdata\changes-gog-legacy.ini"
type changes\changes-legacypc-intro.ini		changes\changes.ini changes\changes-legacy-outro.ini		override.txt > "Expanded Galaxy Main Installer\tslpatchdata\changes-legacypc.ini"
...
type changes\changes-macsteam-intro.ini		changes\changes.ini changes\changes-mac-outro.ini			override.txt > "Expanded Galaxy Main Installer\tslpatchdata\changes-macsteam.ini"
