...
type changes\changes-android-intro.ini		changes\changes.ini changes\changes-android-ios-outro.ini	override.txt > "Expanded Galaxy Main Installer\tslpatchdata\changes-android.ini"
...
type changes\changes-ios-intro.ini			changes\changes.ini changes\changes-android-ios-outro.ini	override.txt > "Expanded Galaxy Main Installer\tslpatchdata\changes-ios.ini"
