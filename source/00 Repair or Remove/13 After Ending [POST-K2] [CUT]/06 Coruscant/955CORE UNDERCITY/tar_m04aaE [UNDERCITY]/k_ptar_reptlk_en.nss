...
void main() {
	...
	object oTar04_reptalker = GetObjectByTag("tar04_reptalker", 0);
	if ((GetIsPC(oEntering) && (!sub1(OBJECT_SELF)))) {
		sub2("TALKIE TALKIE", 5, 5, 5.0);
		sub3(OBJECT_SELF, 1);
		AssignCommand(oTar04_reptalker, ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", ""));
	}
}
