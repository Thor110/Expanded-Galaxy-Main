...
void main() {
	ChangeToStandardFaction(GetObjectByTag("tar04_sithtrooper0", 0), 1);
	AssignCommand(GetObjectByTag("tar04_sithtrooper0", 0), sub1(OBJECT_INVALID));
	ChangeToStandardFaction(GetObjectByTag("tar04_sithtrooper0", 1), 1);
	AssignCommand(GetObjectByTag("tar04_sithtrooper0", 1), sub1(OBJECT_INVALID));
