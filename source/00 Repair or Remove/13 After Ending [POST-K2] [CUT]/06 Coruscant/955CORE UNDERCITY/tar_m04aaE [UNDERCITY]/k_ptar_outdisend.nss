...
void main() {
	...
	sub1(GetObjectByTag("infectedoutcastm", 0));
	sub1(GetObjectByTag("InfectedOutcastF", 0));
	AssignCommand(GetObjectByTag("infectedoutcastm", 0), sub3(GetObjectByTag("tar04_infoutexit", 0), 0));
	AssignCommand(GetObjectByTag("InfectedOutcastF", 0), sub3(GetObjectByTag("tar04_infoutexit", 0), 0));
}
