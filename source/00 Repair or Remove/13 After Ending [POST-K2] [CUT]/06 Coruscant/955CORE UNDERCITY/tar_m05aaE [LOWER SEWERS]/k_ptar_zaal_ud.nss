		...
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					...
					if ((((!GetIsObjectValid(oNearest)) || (GetDistanceBetween(GetFirstPC(), oNearest) > 15.0)) && (GetDistanceBetween(GetFirstPC(), OBJECT_SELF) < 10.0))) {
						sub1(GetTag(OBJECT_SELF), "tar05_zaalbar", OBJECT_INVALID);
					}
				}
				else {
					if ((int1 == 1005)) {
