...
void main() {
	...
	sub1(GetObjectByTag("sarna021", 0));
	DestroyObject(GetObjectByTag("yungenda021", 0), 0.0, 0, 0.0);
	AssignCommand(GetObjectByTag("sarna021", 0), sub3(GetObjectByTag("tar02_swnpcext", 0), 0));
}
