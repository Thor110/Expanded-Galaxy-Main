...
void main() {
	...
	if (((oEntering == GetObjectByTag("christya021", 0)) && (!sub1(oEntering, intGLOB_1)))) {
		sub2(oEntering, intGLOB_1, 1);
	}
	else {
		if (((GetIsPC(oEntering) && sub1(GetObjectByTag("christya021", 0), intGLOB_1)) && (!sub3(OBJECT_SELF)))) {
			sub4(OBJECT_SELF, 1);
			AssignCommand(GetObjectByTag("noble021", 0), ActionStartConversation(GetObjectByTag("christya021", 0), "", 0, 0, 0, "", "", "", "", "", ""));
		}
	}
}
