	...
	if ((int1 == 1001)) {
		...
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				...
				sub1("END OF ROUND", 5, 5, 2.0);
				if (((GetCurrentHitPoints(GetFirstPC()) == 1) && (!sub2(OBJECT_SELF, intGLOB_1)))) {
					sub1("YOU ARE DEAD", 5, 5, 5.0);
					...
					AssignCommand(GetFirstPC(), ActionPlayAnimation(26, 1.0, 60.0));
					NoClicksFor(3.2);
					DelayCommand(3.0, AssignCommand(oK_ptar_invis_speaker, ActionStartConversation(oK_ptar_invis_speaker, "", 0, 0, 1, "", "", "", "", "", "")));
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((oGerlonTwof021 == oAttacker)) {
							sub1("FIRING UD ATTACKED", 5, 5, 5.0);
							CancelCombat(OBJECT_SELF);
						}
					}
					else {
						if ((int1 == 1006)) {
							object object9 = GetObjectByTag("k_ptar_invis_speaker", 0);
							sub1(("HITPOINTS-" + IntToString(GetCurrentHitPoints(OBJECT_SELF))), 5, 6, 5.0);
							if (((GetCurrentHitPoints(OBJECT_SELF) == 1) && (!sub2(OBJECT_SELF, intGLOB_1)))) {
								sub1("FIRING UD DAMAGED", 5, 5, 5.0);
								sub3(OBJECT_SELF, intGLOB_1, 1);
								ClearAllActions();
								SurrenderToEnemies();
								SetPlotFlag(OBJECT_SELF, 1);
								ActionPlayAnimation(26, 1.0, 360.0);
								if (GetGlobalBoolean("TAR_DUELINPROGRESS")) {
									SetGlobalNumber("Tar_Duel", (GetGlobalNumber("Tar_Duel") + 1));
									SetGlobalBoolean("TAR_DUELOVER", 1);
									SetGlobalBoolean("TAR_DUELLOST", 0);
									NoClicksFor(3.2);
									DelayCommand(3.0, AssignCommand(object9, ActionStartConversation(object9, "", 0, 0, 1, "", "", "", "", "", "")));
									SetCommandable(0, OBJECT_SELF);
								}
							}
						}
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 2000)) {
												...
												if ((int1 == 3000)) {
													SurrenderToEnemies();
													ClearAllActions();
													ActionPlayAnimation(23, 1.0, 1000.0);
												}
												else {
													if ((int1 == 4000)) {
														effect efNext;
														sub3(OBJECT_SELF, intGLOB_1, 0);
														efNext = GetFirstEffect(OBJECT_SELF);
														while (GetIsEffectValid(efNext)) {
														...
														if ((int1 == 5000)) {
															...
															if ((int1 == 6000)) {
																...
																DelayCommand(0.5, sub4(GetFirstPC()));
															}
														}
													}
												}
