...
void main() {
	...
	while (GetIsObjectValid(oAreaObject)) {
		if (((GetTag(oAreaObject) == "kandonguard02") || (GetTag(oAreaObject) == "kandonark102"))) {
			...
			DelayCommand(1.0, AssignCommand(oAreaObject, sub1(OBJECT_INVALID)));
		}
		oAreaObject = GetNextObjectInArea(OBJECT_INVALID, 1);
	}
	ChangeToStandardFaction(GetObjectByTag("KandonArk101", 0), 1);
	DelayCommand(1.0, AssignCommand(GetObjectByTag("KandonArk101", 0), sub1(OBJECT_INVALID)));
}
