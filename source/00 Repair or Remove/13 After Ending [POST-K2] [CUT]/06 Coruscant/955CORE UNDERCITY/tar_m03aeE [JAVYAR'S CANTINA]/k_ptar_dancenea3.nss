...
void sub1() {
	ActionMoveToObject(GetObjectByTag("tar03_wpdancenear", 0), 0, 0.2);
	ActionDoCommand(SetFacingPoint(GetPosition(GetObjectByTag("bibsurool", 0))));
	if (sub2(15, 1, GetFirstPC())) {
		ActionPlayAnimation(16, 1.0, 2.0);
		ActionPlayAnimation(114, 1.0, 1.0);
		ActionPlayAnimation(16, 1.0, 2.0);
		ActionPlayAnimation(109, 1.0, 1.0);
		ActionPlayAnimation(17, 1.0, 2.0);
		ActionPlayAnimation(114, 1.0, 1.0);
		ActionPlayAnimation(16, 1.0, 2.0);
		...
		ActionPlayAnimation(109, 1.0, 1.0);
		ActionPlayAnimation(17, 1.0, 2.0);
		ActionPlayAnimation(23, 1.0, 3.0);
