void main() {
	...
	if ((GetLocked(GetObjectByTag("wall2", 0)) == 0)) {
		AssignCommand(GetObjectByTag("wall2", 0), PlayAnimation(201, 1.0, 0.0));
		SetLocked(GetObjectByTag("wall2", 0), 1);
	}
	else {
		AssignCommand(GetObjectByTag("wall2", 0), PlayAnimation(200, 3.0, 0.0));
		SetLocked(GetObjectByTag("wall2", 0), 0);
	}
	if ((GetLocked(GetObjectByTag("wall4", 0)) == 0)) {
		AssignCommand(GetObjectByTag("wall4", 0), PlayAnimation(201, 1.0, 0.0));
		SetLocked(GetObjectByTag("wall4", 0), 1);
	}
	else {
		AssignCommand(GetObjectByTag("wall4", 0), PlayAnimation(200, 3.0, 0.0));
		SetLocked(GetObjectByTag("wall4", 0), 0);
	}
