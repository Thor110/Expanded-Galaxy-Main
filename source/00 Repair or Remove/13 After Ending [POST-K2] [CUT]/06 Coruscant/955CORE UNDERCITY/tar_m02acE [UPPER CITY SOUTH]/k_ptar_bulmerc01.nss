...
void main() {
	...
	object oBulliedmer021 = GetObjectByTag("bountyhunt022", 0);
	sub1(oBulliedmer021);
	DelayCommand(3.0, AssignCommand(oBulliedmer021, sub3(oTar02_wpnpcext, 0)));
	oBulliedmer021 = GetObjectByTag("bountyhunt023", 0);
	sub1(OBJECT_SELF);
	sub1(oBulliedmer021);
	DelayCommand(3.0, AssignCommand(oBulliedmer021, sub3(oTar02_wpnpcext, 0)));
	oBulliedmer021 = GetObjectByTag("bulliedmer021", 0);
	sub1(oBulliedmer021);
