...
void main() {
	...
	if (((GetIsPC(oEntering) && GetGlobalBoolean("Tar_SwoopRace")) && (!sub1(OBJECT_SELF)))) {
		...
		sub2("spawning canderous", 5, 5, 5.0);
		sub3(OBJECT_SELF, 1);
		oTar03_cander031 = CreateObject(1, "tar03_cander031", GetLocation(GetObjectByTag("tar02_spcand", 0)), 0);
		AssignCommand(oTar03_cander031, ActionStartConversation(oEntering, "", 0, 0, 0, "", "", "", "", "", ""));
	}
}
