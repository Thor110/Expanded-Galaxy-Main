...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	object object3 = GetPartyMemberByIndex(1);
	ChangeToStandardFaction(GetObjectByTag("Trooper1", 0), 1);
	DelayCommand(1.0, AssignCommand(GetObjectByTag("Trooper1", 0), sub1(OBJECT_INVALID)));
	ChangeToStandardFaction(GetObjectByTag("Droid1", 0), 1);
	DelayCommand(1.0, AssignCommand(GetObjectByTag("Droid1", 0), sub1(OBJECT_INVALID)));
	ChangeToStandardFaction(GetObjectByTag("Droid2", 0), 1);
	DelayCommand(1.0, AssignCommand(GetObjectByTag("Droid2", 0), ActionAttack(GetObjectByTag("carth", 0), 0)));
	ChangeToStandardFaction(GetObjectByTag("Duros", 0), 2);
	DelayCommand(0.5, AssignCommand(GetObjectByTag("Duros", 0), sub1(OBJECT_INVALID)));
	AssignCommand(oNPC, SetFacingPoint(GetPosition(GetObjectByTag("Trooper1", 0))));
	SetLockOrientationInDialog(object3, 0);
}
