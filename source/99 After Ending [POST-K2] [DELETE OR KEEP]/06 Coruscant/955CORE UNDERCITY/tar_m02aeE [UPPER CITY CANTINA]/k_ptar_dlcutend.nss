...
void main() {
	...
	AssignCommand(oDeadeyeDun021, sub1(intGLOB_130, 0));
	AssignCommand(oGerlonTwof021, sub1(intGLOB_130, 0));
	sub2();
	DestroyObject(GetNearestObjectByTag("g_w_blstrpstl001", oDeadeyeDun021, 1), 0.0, 0, 0.0);
	SetGlobalBoolean("TAR_DUELINPROGRESS", 0);
	SetGlobalFadeIn(1.0, 1.0, 0.0, 0.0, 0.0);
	SetCommandable(1, oDeadeyeDun021);
	AssignCommand(oGerlonTwof021, ActionJumpToLocation(GetGlobalLocation("TAR_DUELCUT_START2")));
}
