...
void main() {
	SetGlobalNumber("Tar_Christya", 2);
	sub1(OBJECT_SELF);
	sub1(GetObjectByTag("noble021", 0));
	sub3(GetObjectByTag("tar02_swnpcext", 0), 0);
	AssignCommand(GetObjectByTag("noble021", 0), sub3(GetObjectByTag("tar02_swnpcext", 0), 0));
}
