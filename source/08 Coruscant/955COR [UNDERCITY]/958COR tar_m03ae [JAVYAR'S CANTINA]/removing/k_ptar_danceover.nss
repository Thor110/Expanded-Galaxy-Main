...
void main() {
	object oLynsekla = GetObjectByTag("lynsekla", 0);
	object oBibsurool = GetObjectByTag("bibsurool", 0);
	object oP_exit = GetObjectByTag("p_exit", 0);
	object oNPC = GetPartyMemberByIndex(1);
	AssignCommand(oNPC, sub1(intGLOB_130, 0));
	oNPC = GetPartyMemberByIndex(2);
	AssignCommand(oNPC, sub1(intGLOB_130, 0));
	sub2(oLynsekla);
	sub2(oBibsurool);
	AssignCommand(oLynsekla, sub4(oP_exit, 0));
	AssignCommand(oBibsurool, sub4(oP_exit, 0));
}
