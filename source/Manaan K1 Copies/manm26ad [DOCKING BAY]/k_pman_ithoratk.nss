...
void main() {
	DelayCommand(0.1, AssignCommand(GetObjectByTag("Ithorak", 0), ActionEquipMostDamagingMelee(OBJECT_INVALID, 0)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("Ithorak", 0), ChangeToStandardFaction(OBJECT_SELF, 1)));
	DelayCommand(0.7, AssignCommand(GetObjectByTag("Ithorak", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.1, AssignCommand(GetObjectByTag("Vek", 0), ActionEquipMostDamagingMelee(OBJECT_INVALID, 0)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("Vek", 0), ChangeToStandardFaction(OBJECT_SELF, 1)));
	DelayCommand(0.7, AssignCommand(GetObjectByTag("Vek", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("VekDroid", 0), ChangeToStandardFaction(OBJECT_SELF, 1)));
	DelayCommand(0.7, AssignCommand(GetObjectByTag("VekDroid", 0), sub1(OBJECT_INVALID)));
}
