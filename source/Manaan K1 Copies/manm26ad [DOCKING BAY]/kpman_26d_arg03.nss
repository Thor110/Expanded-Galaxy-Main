...
void main() {
	object oMan26_reparg = GetObjectByTag("man26_reparg", 0);
	AssignCommand(oMan26_reparg, ActionWait(0.5));
	AssignCommand(oMan26_reparg, sub1("man26_reparg", "", OBJECT_INVALID));
