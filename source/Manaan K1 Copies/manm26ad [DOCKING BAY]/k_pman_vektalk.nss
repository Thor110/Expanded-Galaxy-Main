...
void main() {
	if ((((sub1(OBJECT_SELF) == 0) && (GetEnteringObject() == GetPartyMemberByIndex(0))) && (GetGlobalNumber("K_geno_Ithorak") == 10))) {
		AssignCommand(GetObjectByTag("Vek", 0), ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", ""));
		sub2(OBJECT_SELF, 1);
	}
}
