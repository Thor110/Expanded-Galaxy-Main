...
void main() {
	...
	sub1();
	AssignCommand(GetPartyMemberByIndex(0), JumpToObject(GetObjectByTag("cut_player", 0), 1));
	AssignCommand(GetPartyMemberByIndex(1), JumpToObject(GetObjectByTag("cut_npc01", 0), 1));
	AssignCommand(GetPartyMemberByIndex(2), JumpToObject(GetObjectByTag("cut_npc02", 0), 1));
}
