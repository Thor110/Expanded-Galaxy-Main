...
void main() {
	ChangeToStandardFaction(GetObjectByTag("InfectedOutcastM", 0), 1);
	AssignCommand(GetObjectByTag("InfectedOutcastM", 0), sub1(OBJECT_INVALID));
	ChangeToStandardFaction(GetObjectByTag("InfectedOutcastF", 0), 1);
	AssignCommand(GetObjectByTag("InfectedOutcastF", 0), sub1(OBJECT_INVALID));
}
