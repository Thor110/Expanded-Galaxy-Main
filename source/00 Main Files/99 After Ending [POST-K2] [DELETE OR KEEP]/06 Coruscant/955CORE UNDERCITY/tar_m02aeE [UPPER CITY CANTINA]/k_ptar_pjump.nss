...
void main() {
	object oBP_ASSOC0_WP = GetObjectByTag("BP_ASSOC0_WP", 0);
	object oBP_ASSOC1_WP = GetObjectByTag("BP_ASSOC1_WP", 0);
	object oBP_ASSOC2_WP = GetObjectByTag("BP_ASSOC2_WP", 0);
	sub1(oBP_ASSOC0_WP, oBP_ASSOC1_WP, oBP_ASSOC2_WP);
	object oDeadeyeDun021 = GetObjectByTag("DeadeyeDun021", 0);
	object oGerlonTwof021 = GetObjectByTag("GerlonTwof021", 0);
	AssignCommand(oDeadeyeDun021, sub4(intGLOB_103, 1));
	AssignCommand(oGerlonTwof021, sub4(intGLOB_103, 1));
}
