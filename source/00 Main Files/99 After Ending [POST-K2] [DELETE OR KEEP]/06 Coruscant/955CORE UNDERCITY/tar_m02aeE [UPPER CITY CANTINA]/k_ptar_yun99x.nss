...
void main() {
	...
	sub1(GetObjectByTag("yungenda021", 0));
	DestroyObject(GetObjectByTag("sarna021", 0), 0.0, 0, 0.0);
	AssignCommand(GetObjectByTag("yungenda021", 0), sub3(GetObjectByTag("tar02_swnpcext", 0), 0));
}
