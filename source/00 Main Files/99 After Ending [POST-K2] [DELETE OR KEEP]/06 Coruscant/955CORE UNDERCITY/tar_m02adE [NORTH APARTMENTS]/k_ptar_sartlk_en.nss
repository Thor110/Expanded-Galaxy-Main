...
void main() {
	...
	object oTar02_sarnatalker = GetObjectByTag("tar02_sarnatalker", 0);
	if (((GetIsPC(oEntering) && (!sub1(OBJECT_SELF))) && sub2(OBJECT_SELF, intGLOB_1))) {
		sub3(OBJECT_SELF, 1);
		sub4("TRIGGER PARTY TALK", 5, 5, 5.0);
		AssignCommand(GetPartyMemberByIndex(0), ClearAllActions());
		AssignCommand(oTar02_sarnatalker, ActionStartConversation(oTar02_sarnatalker, "tar02_sarna021", 0, 0, 0, "", "", "", "", "", ""));
	}
}
