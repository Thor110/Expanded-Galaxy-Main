...
void main() {
	object oMan_party0_jump2 = GetObjectByTag("man_party0_jump2", 0);
	object oMan_party1_jump = GetObjectByTag("man_party1_jump", 0);
	object oMan_party2_jump = GetObjectByTag("man_party2_jump", 0);
	sub1(0.5);
	AssignCommand(GetObjectByTag("Vekdroid", 0), JumpToLocation(GetLocation(GetObjectByTag("wp_vekdroid1", 0))));
	SetLockOrientationInDialog(GetObjectByTag("Vekdroid", 0), 1);
	DelayCommand(0.2, sub2(oMan_party0_jump2, oMan_party1_jump, oMan_party2_jump));
}
