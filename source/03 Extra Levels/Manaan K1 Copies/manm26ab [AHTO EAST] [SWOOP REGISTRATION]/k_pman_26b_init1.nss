...
void main() {
	if ((sub1() && GetIsPC(GetEnteringObject()))) {
		AssignCommand(GetObjectByTag("man26_sithneg", 0), ClearAllActions());
		AssignCommand(GetObjectByTag("man26_sithneg", 0), ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", "", 0));
	}
}
