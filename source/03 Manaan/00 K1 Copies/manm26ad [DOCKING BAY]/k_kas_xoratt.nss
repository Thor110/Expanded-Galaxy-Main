...
void main() {
	...
	DelayCommand(0.5, AssignCommand(GetObjectByTag("kas_xor1", 0), sub1(GetObjectByTag("Juhani", 0))));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("kas_xor2", 0), sub1(GetObjectByTag("Juhani", 0))));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("kas_xor3", 0), sub1(GetObjectByTag("Juhani", 0))));
}
