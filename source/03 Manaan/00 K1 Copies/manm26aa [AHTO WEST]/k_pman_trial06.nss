void main() {
	...
	AssignCommand(oMan26_sunry, ActionDoCommand(DestroyObject(oMan26_sunry, 0.0, 0, 0.0)));
	AssignCommand(oMan26_elora, ActionForceMoveToObject(oMan26a_eloraleave, 0, 1.0, 30.0));
	AssignCommand(oMan26_elora, ActionDoCommand(DestroyObject(oMan26_sunry, 0.0, 0, 0.0)));
