...
void main() {
	object oMan_party_jump0 = GetObjectByTag("man_party_jump0", 0);
	object oMan_party_jump1 = GetObjectByTag("man_party_jump1", 0);
	object oMan_party_jump2 = GetObjectByTag("man_party_jump2", 0);
	SetPartyLeader(0xFFFFFFFF);
	sub1(oMan_party_jump0, oMan_party_jump1, oMan_party_jump2);
	DelayCommand(0.2, AssignCommand(GetObjectByTag("Lorgal", 0), SetFacingPoint(GetPosition(GetFirstPC()))));
}
