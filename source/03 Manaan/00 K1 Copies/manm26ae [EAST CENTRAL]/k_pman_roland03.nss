...
int sub3() {
	int int1;
	if ((sub1(OBJECT_SELF, intGLOB_127) == 0)) {
		int1 = 1;
...
void main() {
	if ((((GetEnteringObject() == GetPartyMemberByIndex(0)) && GetGlobalBoolean("MAN_HRAKERT_START")) && (sub1(OBJECT_SELF, intGLOB_120) == 0))) {
		if (((sub2() >= intGLOB_156) && sub3())) {
			sub5("man26_repdip", "", OBJECT_INVALID);
			sub4(OBJECT_SELF, intGLOB_120, 1);
		}
		else {
			if ((sub1(OBJECT_SELF, intGLOB_119) == 0)) {
				sub4(OBJECT_SELF, intGLOB_119, 1);
				sub5("man26_repdip", "", OBJECT_INVALID);
			}
		}
	}
