...
void main() {
	int int1 = sub1(8, 0);
	sub2(int1);
	SetGlobalBoolean("MAN_SEO", 1);
	effect efDeath = EffectDeath(0, 1);
	int int3 = 0;
	object oMan27_adroid01 = GetObjectByTag("man27_adroid01", int3);
	while (GetIsObjectValid(oMan27_adroid01)) {
		ApplyEffectToObject(0, efDeath, oMan27_adroid01, 0.0);
		(int3++);
		oMan27_adroid01 = GetObjectByTag("man27_adroid01", int3);
	}
}
