...
void main() {
	int int1 = sub1(10, 0);
	sub2(int1);
	SetGlobalBoolean("MAN_FC", 1);
	int int3 = 1;
	object oNearestMan27_room1 = GetNearestObjectByTag("man27_room1", OBJECT_SELF, 1);
	while (GetIsObjectValid(oNearestMan27_room1)) {
		DelayCommand(0.5, ApplyEffectToObject(0, EffectVisualEffect(4003, 0), oNearestMan27_room1, 0.0));
		(int3++);
		oNearestMan27_room1 = GetNearestObjectByTag("man27_room1", OBJECT_SELF, int3);
	}
}
