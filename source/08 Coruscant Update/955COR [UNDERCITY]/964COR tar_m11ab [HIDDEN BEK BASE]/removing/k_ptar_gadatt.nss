...
void main() {
	object oGadonthek111 = GetObjectByTag("gadonthek111", 0);
	object oKaeira111 = GetObjectByTag("kaeira111", 0);
	ChangeToStandardFaction(oGadonthek111, 1);
	DelayCommand(1.0, AssignCommand(oGadonthek111, sub1(OBJECT_INVALID)));
	ChangeToStandardFaction(oKaeira111, 1);
	DelayCommand(1.0, AssignCommand(oKaeira111, sub1(OBJECT_INVALID)));
}
