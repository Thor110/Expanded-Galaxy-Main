...
void main() {
	...
	if ((int1 == 1001)) {
		object oNearest = GetNearestCreature(3, 1, GetPartyMemberByIndex(0), 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
		if (((GetIsObjectValid(oNearest) && GetObjectSeen(oNearest, OBJECT_SELF)) && (GetStandardFaction(OBJECT_SELF) != 1))) {
