...
void main() {
	object oNearestTar08_ceilingfall = GetNearestObjectByTag("tar08_ceilingfall", GetObjectByTag("tar08_wpcollapse0", 0), 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	ChangeToStandardFaction(GetObjectByTag("calo082", 0), 1);
	DelayCommand(1.0, sub1(OBJECT_INVALID));
	DelayCommand(1.0, AssignCommand(GetObjectByTag("calo082", 0), sub1(OBJECT_INVALID)));
}
