...
void main() {
	...
	sub1(oCalo031, 1);
	AssignCommand(oCalo031, sub2(intGLOB_130, 1));
	ActionPauseConversation();
	ChangeToStandardFaction(oCalo031, 2);
	ChangeToStandardFaction(oTaproomvic031, 4);
	ChangeToStandardFaction(oTaproomvic032, 4);
	ChangeToStandardFaction(oTaproomvic033, 4);
	AssignCommand(oCalo031, PlayAnimation(118, 1.0, 0.0));
