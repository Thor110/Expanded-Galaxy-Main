	...
	switch (int1) {
		case 2000:
			if ((!sub1(OBJECT_SELF, intGLOB_1))) {
				...
				CancelCombat(oCalo032);
				sub3(oCalo032, 1);
				AssignCommand(oCalo032, ClearAllActions());
				AssignCommand(oCalo032, sub4(intGLOB_130, 0));
				AssignCommand(oCalo032, ActionMoveToObject(GetObjectByTag("tar03_npcext", 0), 0, 1.0));
				ActionWait(2.0);
