...
void sub82() {
	...
	if (((GetIsObjectValid(oNearestTar04_alphaghoul) && (fDistance > 20.0)) && (fDistance < 40.0))) {
...
void sub80() {
	...
	int nRandom = Random(100);
	float float7 = (Random(6) + 7.0);
	object oNearestTar04_vulkarenf = GetNearestObjectByTag("tar04_vulkarenf", OBJECT_SELF, 1);
	float fDistance = GetDistanceBetween(OBJECT_SELF, oNearestTar04_vulkarenf);
	if (((GetIsObjectValid(oNearestTar04_vulkarenf) && (fDistance > 20.0)) && (fDistance < 40.0))) {
		ActionMoveToObject(oNearestTar04_vulkarenf, 0, 1.0);
	}
	else {
		if ((nRandom < 60)) {
			struct4 = Vector(((Random(201) - 100) * 0.01), ((Random(201) - 100) * 0.01), 0.0);
...
void sub79(int intParam1) {
	...
	ActionDoCommand(sub79(intParam1));
}
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub9(intGLOB_50, 1));
					}
					else {
...
void sub75() {
	if ((!sub6(intGLOB_59))) {
		...
		string string2 = "WP_";
		string string3;
		int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_47);
		int int4 = GetLocalNumber(OBJECT_SELF, intGLOB_48);
		int int6 = GetLocalNumber(OBJECT_SELF, intGLOB_49);
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub6(intGLOB_56)) {
				...
				if (((nLocal < int4) && (!sub6(intGLOB_56)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub6(intGLOB_57), 2.5, float3);
			if (sub6(intGLOB_50)) {
				ActionDoCommand(sub77());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_47, nLocal);
			if ((string2 != "UNKNOWN")) {
...
int sub73(object objectParam1) {
	...
	int nLocal = GetLocalNumber(objectParam1, intGLOB_49);
	string string5;
	if ((nLocal < 10)) {
...
int sub70() {
	...
	if ((sub6(intGLOB_105) && (!sub6(intGLOB_106)))) {
		if (sub71()) {
			return 1;
		}
	}
...
int sub68(object objectParam1) {
	...
	if (sub14(intGLOB_121, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub14(intGLOB_119, object1)) {
			return 1;
		}
	}
	object object4 = sub13();
	if (GetIsObjectValid(object4)) {
		if (sub14(intGLOB_120, object4)) {
			return 1;
		}
	}
	object3 = sub27();
	...
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub22(intGLOB_6, 1);
		}
		else {
			talent1 = sub22(intGLOB_6, 0);
		}
	}
	else {
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub22(intGLOB_7, 1);
			}
			else {
				talent1 = sub22(intGLOB_7, 0);
			}
		}
	}
...
talent sub50(int intParam1) {
	SetLocalBoolean(OBJECT_SELF, intGLOB_46, 0);
																					...
																					if ((intParam1 == intGLOB_40)) {
																						...
																						if ((intParam1 == intGLOB_41)) {
																							...
																							if ((intParam1 == intGLOB_42)) {
																								...
																								if (((intParam1 == intGLOB_43) || (intParam1 == intGLOB_44))) {
...
talent sub33(int intParam1) {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		SetLocalNumber(OBJECT_SELF, intGLOB_12, 0);
		SetLocalNumber(OBJECT_SELF, intGLOB_11, 0);
		nRandom = d6(1);
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				...
				SetLocalNumber(OBJECT_SELF, intGLOB_12, 1);
				SetLocalNumber(OBJECT_SELF, intGLOB_11, int2);
				return sub50(int2);
			}
			else {
...
int sub31(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_119, oNPC)) {
			return 1;
		}
	}
	oNPC = sub13();
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_120, oNPC)) {
			return 1;
		}
	}
	talent1 = sub33(0);
	int nLocalBool = GetLocalBoolean(OBJECT_SELF, intGLOB_46);
	if ((nLocalBool == 1)) {
...
talent sub22(int intParam1, int intParam2) {
	...
	talent talRandom;
	int int1 = 0;
	if (((intParam1 == intGLOB_5) || (intParam1 == intGLOB_9))) {
	...
	if (((intParam1 == intGLOB_6) || (intParam1 == intGLOB_9))) {
	...
	if (((intParam1 == intGLOB_7) || (intParam1 == intGLOB_9))) {
		if ((d100(1) > 50)) {
		...
		if (((intParam1 == intGLOB_8) || (intParam1 == intGLOB_9))) {
			if ((d100(1) > 70)) {
				talRandom = sub25(intParam2);
				if (GetIsTalentValid(talRandom)) {
					return talRandom;
...
int sub14(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		int int3 = 0;
		int int4 = 0;
		if ((intParam1 == intGLOB_118)) {
			int2 = 61473;
		}
		else {
			if ((intParam1 == intGLOB_119)) {
...
int sub10() {
	int int1 = 0;
	if (((sub6(intGLOB_112) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub6(intGLOB_109))) {
...
int sub7() {
	...
	sub2(((("GENERIC DEBUG *************** Shield Boolean (" + sub8(intGLOB_110)) + ") = ") + sub8(sub6(intGLOB_110))));
	if (((sub6(intGLOB_110) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub4() {
	...
	structGLOB_1.int13 = GetLocalNumber(OBJECT_SELF, intGLOB_12);
	structGLOB_1.int15 = GetLocalNumber(OBJECT_SELF, intGLOB_11);
}
...
void sub1(object objectParam1) {
	...
	sub4();
	{
		...
		if (((((!sub6(intGLOB_105)) && (!sub6(intGLOB_106))) && (!sub6(intGLOB_107))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub6(intGLOB_115) == 1)) {
					if ((sub11() == 1)) {
						return;
					}
				}
				if ((sub6(intGLOB_109) == 1)) {
...
void main() {
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
	if (GetIsObjectValid(oNearest)) {
		DelayCommand(0.1, sub1(OBJECT_INVALID));
		return;
	}
	DelayCommand(0.1, sub79(intGLOB_1));
}
