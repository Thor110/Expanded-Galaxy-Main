...
void sub3() {
	if (((!GetIsConversationActive()) && (!sub1(OBJECT_SELF, intGLOB_127)))) {
		if ((Random(3) > 0)) {
								...
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 2000)) {
												sub4("AGENT LEAVING", 5, 9, 5.0);
												sub5(OBJECT_SELF);
												ClearAllActions();
												sub6(GetObjectByTag("tar03_wpnpcext", 0), 0);
											}
											else {
												if ((int1 == 3000)) {
													ClearAllActions();
													ActionStartConversation(OBJECT_SELF, "tar03_cand032", 0, 0, 0, "", "", "", "", "", "");
												}
												else {
													if ((int1 == intGLOB_138)) {
														sub7("wp_homebase");
