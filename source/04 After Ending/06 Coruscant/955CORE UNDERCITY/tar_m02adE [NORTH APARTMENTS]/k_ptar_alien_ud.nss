...
void sub7(object objectParam1) {
	sub2(objectParam1, intGLOB_127, 1);
}
...
void sub3() {
	if (((!GetIsConversationActive()) && (!sub1(OBJECT_SELF, intGLOB_120)))) {
		ApplyEffectToObject(1, EffectHorrified(), OBJECT_SELF, 3.0);
	}
	else {
		ActionWait(3.0);
	}
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 2000)) {
												if (sub1(OBJECT_SELF, intGLOB_119)) {
													...
													if (((GetDistanceBetween(OBJECT_SELF, GetFirstPC()) < 12.0) && (!sub1(OBJECT_SELF, intGLOB_127)))) {
														object oNPC;
														int int6 = 0;
														...
														sub4("THANK YOU SIR", 5, 5, 5.0);
														ClearAllEffects();
														ClearAllActions();
														NoClicksFor(1.7);
														DelayCommand(1.5, sub5(GetTag(OBJECT_SELF), "", OBJECT_INVALID));
													}
													sub7(OBJECT_SELF);
												}
												else {
