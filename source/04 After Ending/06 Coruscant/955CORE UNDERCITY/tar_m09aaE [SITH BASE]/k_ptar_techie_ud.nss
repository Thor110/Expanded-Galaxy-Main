...
void main() {
	...
	if ((int1 == 1001)) {
		if (((Random(3) > 1) && (!sub1(OBJECT_SELF)))) {
			object oTar09_techterminal = GetObjectByTag("tar09_techterminal", 0);
			if ((GetDistanceBetween(oTar09_techterminal, OBJECT_SELF) <= 1.0)) {
				SetFacingPoint(GetPosition(oTar09_techterminal));
