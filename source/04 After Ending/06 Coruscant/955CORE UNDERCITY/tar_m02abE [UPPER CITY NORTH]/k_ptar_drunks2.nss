...
// Prototypes
void sub7();
void sub6(string stringParam1, string stringParam2, object objectParam3);
...
void main() {
	...
	if ((((string1 == "drunk021") || (string1 == "drunk022")) || (string1 == "drunk023"))) {
	...
	if ((((GetIsPC(oEntering) && (!sub3(OBJECT_SELF))) && sub1(OBJECT_SELF, intGLOB_3)) && sub4(OBJECT_INVALID))) {
		sub5(OBJECT_SELF, 1);
		sub6("drunk021", "", OBJECT_INVALID);
	}
}
