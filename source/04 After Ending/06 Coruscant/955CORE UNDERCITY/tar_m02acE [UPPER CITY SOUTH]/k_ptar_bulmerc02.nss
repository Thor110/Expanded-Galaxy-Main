...
void main() {
	...
	sub2(GetObjectByTag("bountyhunt022", 0));
	sub2(GetObjectByTag("bountyhunt023", 0));
	sub2(GetObjectByTag("bulliedmerc021", 0));
	ChangeToStandardFaction(GetObjectByTag("bountyhunt022", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("bountyhunt023", 0), 1);
	DelayCommand(1.0, AssignCommand(GetObjectByTag("bountyhunt022", 0), sub4(OBJECT_INVALID)));
	DelayCommand(1.0, AssignCommand(GetObjectByTag("bountyhunt023", 0), sub4(OBJECT_INVALID)));
}
