...
void main() {
	object oGanaLavin021 = GetObjectByTag("GanaLavin021", 0);
	object oEntering = GetEnteringObject();
	if (((GetIsPC(oEntering) && GetIsObjectValid(oGanaLavin021)) && (!sub1(OBJECT_SELF)))) {
		sub2("GANA SPEAK", 5, 5, 5.0);
		sub3(OBJECT_SELF, 1);
		sub4(oGanaLavin021);
		BarkString(OBJECT_SELF, 22214);
		ExecuteScript("k_ptar_gana20a", OBJECT_SELF, 0xFFFFFFFF);
	}
}
