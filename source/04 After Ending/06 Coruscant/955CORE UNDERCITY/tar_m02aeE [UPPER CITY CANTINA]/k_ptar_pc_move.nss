...
void main() {
	...
	location location1 = GetLocation(GetObjectByTag("BP_PC_WP", 0));
	location location3 = GetLocation(GetObjectByTag("BP_ASSOC0_WP2", 0));
	ActionPauseConversation();
	sub1(oNPC, location3);
	DelayCommand(0.5, AssignCommand(oNPC, ActionMoveToLocation(location1, 0)));
