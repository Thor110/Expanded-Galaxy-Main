...
void main() {
	...
	if(GetGlobalNumber("262TEL_Escape_Telos") == 1)
	{
		...
		{
			SetPlanetAvailable(nWorld, TRUE);
			SetPlanetSelectable(nWorld, TRUE);
		}
	...
	if(GetGlobalNumber("852NIH_Nihilus_Dead") == 1)// This number variable could become a boolean.
	{
	...
	//}
	if(GetGlobalBoolean("CARTH_SCENE") == 1)
	{
